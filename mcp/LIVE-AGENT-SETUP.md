...
$env:AI_FOUNDRY_ENDPOINT = 'https://<resource>.services.ai.azure.com/models/chat/completions?api-version=2024-05-01-preview'
$env:AI_FOUNDRY_API_KEY = '<from-portal>'
$env:AI_FOUNDRY_DEPLOYMENT = '<your-deployment-name>'
$env:AI_FOUNDRY_AUTH = 'api-key' # or 'bearer'
```

`AI_FOUNDRY_ENDPOINT`는 전체 POST URL입니다. Cockpit 서버는 경로를 덧붙이지 않으며, 키나 전체 URL을 health 응답에 노출하지 않습니다.
